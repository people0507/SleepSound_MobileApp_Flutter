                ...
                children: [
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Column(
                              children: [
                                Container(
                                  decoration: const BoxDecoration(border: Border(bottom: BorderSide(color: ColorPalette.slidingupColor))),
                                  height: 56,
                                  width: double.infinity,
                                  child: TextButton(
                                      onPressed: () {
                                      ...
                                      child: Row(
                                        children: [
                                          const Text('01',style: TextStyle(fontSize: 13,color: ColorPalette.detaildesColor),),
                                          Padding(
                                            ...
                                            child: Container(
                                              ...
                                              const Text('The Guitars ',style: TextStyle(fontSize: 17,color: Colors.white))
                                        ],
                                      )),
                                ),
                                Container(
                                  ...
                                  child: TextButton(
                                      ...
                                      child: Row(
                                        children: [
                                          const Text('02',style: TextStyle(fontSize: 13,color: ColorPalette.detaildesColor),),
                                          Padding(
                                            padding: const EdgeInsets.symmetric(horizontal: 10),
                                            child: Container(
                                              width: 32,
                                              ...
                                              const Text('Lost Without You',style: TextStyle(fontSize: 17,color: Colors.white))
                                        ],
                                      )),
                                ),
                                Container(
                                  ...
                                  child: TextButton(
                                      ...
                                      child: Row(
                                        children: [
                                          const Text('03',style: TextStyle(fontSize: 13,color: ColorPalette.detaildesColor),),
                                          Padding(
                                            padding: const EdgeInsets.symmetric(horizontal: 10),
                                            child: Container(
                                              width: 32,
                                              ...
                                              const Text('City Lights',style: TextStyle(fontSize: 17,color: Colors.white))
                                        ],
                                      )),
                                ),
                                SizedBox(
                                  ...
                                  child: TextButton(
                                      ...
                                      child: Row(
                                        children: [
                                          const Text('04',style: TextStyle(fontSize: 13,color: ColorPalette.detaildesColor),),
                                          Padding(
                                            padding: const EdgeInsets.symmetric(horizontal: 10),
                                            child: Container(
                                              width: 32,
                                              ...
                                              const Text('Romantic',style: TextStyle(fontSize: 17,color: Colors.white))
                                        ],
                                      )),
                                )
                              ],
                  ...
                  Padding(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text('Featured On',style: TextStyle(fontSize: 17,color: Colors.white,fontWeight: FontWeight.bold),),
                        const SizedBox(
                          height: 15,
                        ),
                        Row(
